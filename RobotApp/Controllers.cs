...
namespace RobotApp
{
    ...
    public class Controllers
    {
        ...
        public static async void SetRobotDirection(CtrlCmds cmd, int speed)
        {
            
            switch (cmd)
            {
                case CtrlCmds.Forward: MotorCtrl.driver.MoveForward();   break;// MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms2;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms1;    break;
                case CtrlCmds.Backward: MotorCtrl.driver.MoveBackward(); break; // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms1;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms2;    break;
                case CtrlCmds.Left: await MotorCtrl.driver.TurnLeftAsync();  break;  // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms1;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms1;    break;
                case CtrlCmds.Right: await MotorCtrl.driver.TurnRightAsync();  break;  // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms2;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms2;    break;
                case CtrlCmds.ForwardLeft: await MotorCtrl.driver.TurnLeftAsync();break;  // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.stop;    MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms1;    break;
                case CtrlCmds.ForwardRight: await MotorCtrl.driver.TurnRightAsync(); break;  // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms2;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.stop;   break;
                case CtrlCmds.BackLeft: await MotorCtrl.driver.TurnLeftAsync(); break;  // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.stop;    MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.ms2;    break;
                case CtrlCmds.BackRight: await MotorCtrl.driver.TurnRightAsync(); break;   // MotorCtrl.waitTimeLeft = MotorCtrl.PulseMs.ms1;     MotorCtrl.waitTimeRight = MotorCtrl.PulseMs.stop;   break;
                default:
                case CtrlCmds.Stop: MotorCtrl.driver.Stop();   break;
            }
